...
class NovatelPsrdop2 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('systems')) {
        this.systems = initObj.systems
      }
      else {
        this.systems = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.gdop, buffer, bufferOffset);
    ...
    // Serialize message field [systems]
    // Serialize the length for message field [systems]
    bufferOffset = _serializer.uint32(obj.systems.length, buffer, bufferOffset);
    obj.systems.forEach((val) => {
      bufferOffset = NovatelPsrdop2System.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NovatelPsrdop2(null);
    ...
    data.gdop = _deserializer.float32(buffer, bufferOffset);
    ...
    // Deserialize message field [systems]
    // Deserialize array length for message field [systems]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.systems = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.systems[i] = NovatelPsrdop2System.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.systems.forEach((val) => {
      length += NovatelPsrdop2System.getMessageSize(val);
    });
    return length + 20;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NovatelPsrdop2(null);
    ...
    if (msg.systems !== undefined) {
      resolved.systems = new Array(msg.systems.length);
      for (let i = 0; i < resolved.systems.length; ++i) {
        resolved.systems[i] = NovatelPsrdop2System.Resolve(msg.systems[i]);
      }
    }
    else {
      resolved.systems = []
